...
#    ]
    ...
    H = [
    Hm,
    [H11a_1,phase(tlist,-1,omega_1 - omega_1) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H11a_2,(phase(tlist,-1,omega_1+omega_1)) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H11b_1,(phase(tlist,+1,omega_1+omega_1)) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H11b_2,phase(tlist,+1,omega_1 - omega_1) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    ...
    [H21a_1,phase(tlist,-1,omega_1-omega_2) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H21a_2,phase(tlist,-1,omega_1+omega_2) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H21b_1,phase(tlist,+1,omega_1+omega_2) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
    [H21b_2,phase(tlist,+1,omega_1-omega_2) * fSTIRAP_P(-tlist,  tau, t_delay, sigma_1)],
