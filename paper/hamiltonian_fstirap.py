...
#    ]
    ...
    H = [
    Hm,
    [H11a_1, np.real(np.exp(1j*rel_phase)) * phase(tlist,-1,omega_1-omega_1) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H11a_2, np.real(np.exp(1j*rel_phase)) * phase(tlist,-1,omega_1+omega_1) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H11b_1, np.real(np.exp(-1j*rel_phase)) * phase(tlist,+1,omega_1+omega_1) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H11b_2, np.real(np.exp(-1j*rel_phase)) * phase(tlist,+1,omega_1-omega_1) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H12a_1, phase(tlist,-1,n*omega_2-omega_1) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H12a_2, phase(tlist,-1,n*omega_2+omega_1) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H12b_1, phase(tlist,+1,n*omega_2+omega_1) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H12b_2, phase(tlist,+1,n*omega_2-omega_1) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H21a_1, np.real(np.exp(1j*rel_phase)) * phase(tlist,-1,omega_1-omega_2) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H21a_2, np.real(np.exp(1j*rel_phase)) * phase(tlist,-1,omega_1+omega_2) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H21b_1, np.real(np.exp(-1j*rel_phase)) * phase(tlist,+1,omega_1+omega_2) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H21b_2, np.real(np.exp(-1j*rel_phase)) * phase(tlist,+1,omega_1-omega_2) * fSTIRAP_P(tlist,  tau, t_delay, sigma_1)],
    [H22a_1, phase(tlist,-1,omega_2 - n*omega_2) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H22a_2, phase(tlist,-1,omega_2 + n*omega_2) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H22b_1, phase(tlist,+1,omega_2 + n*omega_2) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)],
    [H22b_2, phase(tlist,+1,omega_2 - n*omega_2) * fSTIRAP_S(tlist,  tau, t_delay, sigma_2)]
    ]
    ...
    ax2.plot(tlist, fSTIRAP_P(tlist, tau, t_delay, sigma_1), marker = '', color = 'red',label = 'P')
    ax2.plot(tlist, fSTIRAP_S(tlist, tau, t_delay, sigma_2), marker = '', color = 'blue', label = 'S')
