...
plot_dir = 'paper/omega1-3omega2-sweep-no-collapse'
output_file = 'paper/omega1-3omega2-sweep-no-collapse.csv'
output_plot = 'paper/omega1-3omega2-sweep-no-collapse.pdf'
import os
