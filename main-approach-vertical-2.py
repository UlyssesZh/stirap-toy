...
values = linspace(1.847e6, 1.853e6, 101, endpoint=False)
for i1, omega1 in enumerate(values*2*pi):
	...
	if i1%1 == 0:
		...
		plt.savefig(f'plot-approach-vertical-2/{i1:03d}.pdf', transparent=True, format='pdf', bbox_inches='tight')

	with open('output-approach-vertical-2.csv', 'a') as f:
