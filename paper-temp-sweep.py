...
plot_dir = 'paper/temp-sweep'
output_file = 'paper/temp-sweep.csv'
output_plot = 'paper/temp-sweep.pdf'
import os
...
for i1, T in enumerate(linspace(0, 2, 51)):
	if i1 < len(T_vals):
		continue
	...
	with open(output_file, 'a') as f:
		f.write(f'{i1},{T},{n1_val},{n2_val}\n')

plt.figure()
plt.plot(T_vals, n2_vals)
plt.xlabel(r"$T$")
