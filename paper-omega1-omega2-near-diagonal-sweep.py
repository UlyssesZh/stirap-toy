...
plot_dir = 'paper/omega1-omega2-near-diagonal-sweep'
output_file = 'paper/omega1-omega2-near-diagonal-sweep.csv'
output_plot = 'paper/omega1-omega2-near-diagonal-sweep.pdf'
import os
