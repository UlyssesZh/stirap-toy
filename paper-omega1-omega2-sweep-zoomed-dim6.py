...
plot_dir = 'paper/omega1-omega2-sweep-zoomed-dim6'
output_file = 'paper/omega1-omega2-sweep-zoomed-dim6.csv'
output_plot = 'paper/omega1-omega2-sweep-zoomed-dim6.pdf'
import os
