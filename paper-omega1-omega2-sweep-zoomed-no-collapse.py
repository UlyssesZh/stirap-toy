...
plot_dir = 'paper/omega1-omega2-sweep-zoomed-no-collapse'
output_file = 'paper/omega1-omega2-sweep-zoomed-no-collapse.csv'
output_plot = 'paper/omega1-omega2-sweep-zoomed-no-collapse.pdf'
import os
